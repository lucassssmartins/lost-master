...
public class InvincibilitySidebarModel extends HungerSidebarModel {

    public InvincibilitySidebarModel(Scoreboard scoreboard) {
        super(scoreboard);
    }
    ...
    public List<String> getModel(Player player) {
        ...
        perPlayer.add("");
        perPlayer.add("§fInvencível por: §7" + formatTime(getMain().getTimer()));
