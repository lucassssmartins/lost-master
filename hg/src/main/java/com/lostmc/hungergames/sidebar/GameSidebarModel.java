...
public class GameSidebarModel extends HungerSidebarModel {

    public GameSidebarModel(Scoreboard scoreboard) {
        super(scoreboard);
    }
    ...
    public List<String> getModel(Player player) {
        ...
        perPlayer.add("");
        perPlayer.add("§fTempo de jogo: §7" + formatTime(getMain().getTimer()));
        ...
        if (!isVanished(player)) {
            ...
            perPlayer.add("§fKills: §a" + gamer.getMatchKills());
        } else {
