package com.lostmc.bukkit.api.nick;
...
public class NickAPI {
	...
	public static void respawnSelf(Player player) {
		...
		try {
			manager.sendServerPacket(player, removePlayerInfo);
			manager.sendServerPacket(player, addPlayerInfo);
			manager.sendServerPacket(player, respawnPlayer);
