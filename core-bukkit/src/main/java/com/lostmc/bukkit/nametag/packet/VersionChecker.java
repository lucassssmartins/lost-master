package com.lostmc.bukkit.nametag.packet;
...
public class VersionChecker {
	...
	static {
		...
		else if (version.contains("(MC: 1.8.4)") || version.contains("(MC: 1.8.5)") || version.contains("(MC: 1.8.6)")
				|| version.contains("(MC: 1.8.7)") || version.contains("(MC: 1.8.8)"))
			bukkitVersion = BukkitVersion.v1_8_R3;
		else if (version.contains("(MC: 1.8.9)"))
			bukkitVersion = BukkitVersion.v1_8_R4;
		else if (version.contains("(MC: 1.9)") || version.contains("(MC: 1.9.1)") || version.contains("(MC: 1.9.2)")
				|| version.contains("(MC: 1.9.3)"))
		...
		else if (version.contains("(MC: 1.14)") || version.contains("(MC: 1.14.1)") || version.contains("(MC: 1.14.2)")
				|| version.contains("(MC: 1.14.3)"))
	...
	public enum BukkitVersion {
		v1_8_R1, v1_8_R2, v1_8_R3, v1_8_R4, v1_9_R1, v1_9_R2, v1_10_R1, v1_11_R1, v1_12_R1, v1_13_R1, v1_13_R2,
		v1_14_R1, v1_14_R2, v1_15_R1, v1_16_R1, v1_16_R2, v1_16_R3, v1_17_R1
	}
}
