...
class PacketAccessor {
	...
	private static final List<String> legacyVersions = Arrays.asList("v1_7_R1", "v1_7_R2", "v1_7_R3", "v1_7_R4",
			"v1_8_R1", "v1_8_R2", "v1_8_R3", "v1_8_R4", "v1_9_R1", "v1_9_R2", "v1_10_R1", "v1_11_R1", "v1_12_R1");
	...
	static {
		...
		try {
			...
			if (CAULDRON_SERVER) {
				...
				sendPacket = typePlayerConnection.getMethod("func_147359_a",
